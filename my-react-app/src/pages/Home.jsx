      ...
      <div className="jara-hatke-page-container">
        ...
        <div className="flex flex-wrap px-2 py-4">
          <div className="flex-1 w-full md:w-3/4">
            <TrendingNews />
            <div className="mt-6"><MpNews /></div>
            <div className="mt-6"><Rajniti /></div>
            <div className="mt-6"><FeaturedVideos /></div>
            <div className="my-4"><AdsenseAd /></div>
            <div className="mt-6"><SportsNews /></div>
          </div>

          {/* Sidebar */}
          <div className="w-full md:w-1/4 pl-3 mt-6 md:mt-0">
            <div className="border border-gray-600"><GoogleAds /></div>
            <WeatherForecasting />
            <SideNews />
            <div className="mt-6"><CategoriesList /></div>
            <div className="mt-6"><SubscribeNews24 /></div>
          </div>
        </div>
        
        <div className="mt-6"><NewsGrid /></div>
