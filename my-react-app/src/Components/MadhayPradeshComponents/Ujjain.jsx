...
const Ujjain = () => {
  const articles = [
    ...
    {
      title: "Health of Ujjain campaign : CM यादव बोले, संत और महात्माओं ने हमें स्वस्थ जीवन शैली अपनाने का पाठ सिखाया",
      description: "Health of Ujjain campaign : मुख्यमंत्री डॉ. मोहन यादव ने कहा है कि भारतीय संस्कृति में ऋषि, मुनियों, संत और महात्माओं ने हमें स्वस्थ जीवन शैली अपनाने का पाठ सिखाया है। उनके बताये मार्गों और सिद्धांतों पर चलकर हम स्वस्थ जीवनशैली प्राप्त कर सकते हैं। आज के युग में आहार, विहार और संयमित दिनचर्या रखने की आवश्यकता है। […]",
      imageUrl: "https://icj24.com/wp-content/uploads/2025/01/08e1e5c2-e35f-47b9-b176-d8ad01285dc9.jpg",
      link: "/5g-networks",
    },
    {
      title: "Ujjain Suicide case: पति से झगड़ा और छत से कूद गई महिला, दर्दनाक मौत",
      description: "Ujjain Suicide case: मध्य प्रदेश के इंदौर में एक दिल दहला देने वाली घटना सामने आई है। यहां 30 वर्षीय एक महिला ने अपने पति से झगड़े के बाद इमारत की तीसरी मंजिल से कूदकर खुद अपनी जान दे दी। घटना रविवार शाम को हुई जिसका एक व्यक्ति ने अपने मोबाइल में वीडियो रिकॉर्ड कर […]",
  ...
  return (
    <div className="max-w-screen-xl mx-auto p-5">
      ...
      <h1 className="text-2xl font-bold  mb-8">उज्जैन न्यूज़</h1>
